...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            html: {
                files: ['<%= config.app %>/**/*.html', '<%= config.fixtures %>/**/*.html'],
                tasks: ['htmlbuild']
            },
            bower: {
                files: ['bower.json'],
        ...
        htmlbuild: {
            server: {
                ...
                options: {
                    ...
                    sections: {
                        layout: {
                            pageHeader: '<%= config.fixtures %>/pageHeader.html',
                            bodyHeader: '<%= config.fixtures %>/bodyHeader.html',
                            pageFooter: '<%= config.fixtures %>/pageFooter.html',
                            bodyFooter: '<%= config.fixtures %>/bodyFooter.html'
                        }
                    },
                    data: {
                        version: '0.1.0',
